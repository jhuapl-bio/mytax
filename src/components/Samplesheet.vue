            ...
            <v-toolbar extended>
                ...
                <template v-slot:extension>
                    <div style="display:flex; " class="mb-4 mt-3">
                        <div id="filedropfilename"   @drop.prevent="addDropFile" @dragover.prevent style="overflow-y: auto" class="" >
                            <v-file-input
                                :width="'100px'"
                                v-model="name" 
                ...
                <v-dialog
                    ...
                    <v-card>
                        ...
                        <v-container>
                            ...
                            >
                                <v-switch
                                v-model="editedItem.demux"
                                label="Demultiplex Sample"
                                ></v-switch>
                            </v-col>
                            <v-col
                                cols="12"
                            ...
                            >
                                ...
                                label="Pattern to Catch from path/demux output"
                                ></v-text-field>
                            </v-col>
                            <v-col
            ...
            >
                ...
                <v-list  :style="{
                    ...
                    > 
                        ...
                        <v-list-item-icon>
                            <v-btn fab x-small @click="drawerSample=true; selectedSampleObj = sample"  
                                >
                                <v-icon> {{  drawerSample ? `mdi-arrow-down` : `mdi-arrow-up` }}</v-icon>
                            </v-btn>
                        </v-list-item-icon>
...
<script>
  ...
  export default { 
    ...
    methods: {
        ...
        deleteItemConfirm () {
            let name = this.dataSamples[this.editedIndex]
            this.dataSamples.splice(this.editedIndex,1)
            this.closeDelete()
            if (name && name.sample){
                this.$emit("deleteRow", name.sample)
            }
        },
        editItem (item) {
