...
import os from 'os'
import { broadcastToAllActiveConnections, broadcastThrottled, flushThrottled, queueLogLine, startLogFlusher, emitToRunViewers, queueMetrics, queueRunMeta } from './messenger.mjs';
    ...
    constructor(){         
        ...
        this.databases = [
            ...
            },
            {
                ...
                decompress: true,
                type: 'kraken2',
                label: 'Standard mitogenomes (2026-09-16)',
                description: 'Standard mitochondrial genomes from RefSeq. Intended for eDNA / mitochondrial barcoding work.',
                final: '20260916_refseq_mitochondrion',
                ...
                nested: false,
                key: 'StandardMitogenome20260916',
                fullpath: path.join(this.databasespath, "20260916_refseq_mitochondrion")
            },
            {
